...
wget -nv http://public-repo-1.hortonworks.com/HCP/centos7/1.x/updates/1.9.0.0/tars/metron/hcp-ambari-mpack-1.9.0.0-9.tar.gz
...
sudo ambari-server install-mpack --mpack=hcp-ambari-mpack-1.9.0.0-9.tar.gz --verbose
